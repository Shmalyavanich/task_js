...
/******/ 	var hotCurrentHash = "05d70e85ac013977d7c1"; // eslint-disable-line no-unused-vars
...
var _formHandler = __webpack_require__(333);
...
var App = function () {
    ...
    _createClass(App, [{
        key: 'impotData',
        value: function impotData() {
            var _this = this;

            fetch(this.dataFilePath).then(function (response) {
                ...
                if (Object.keys(data).length > 0) {
                    ...
                    _this.insertTableData(data);

                    //скрыть loader
                    var loaderClassList = document.querySelector(_this.LoaderSelector).classList,
                        hiddenClass = _this.hiddenClass;
        ...
        key: 'insertTableData',
        value: function insertTableData(data) {
        ...
        key: 'insertTableRow',
        value: function insertTableRow(data, rowKey) {
            var newRowHtml = '',
                phoneName = '',
                phoneScreenSize = '',
                phoneRam = '',
            ...
            if (data.phone_length !== undefined && data.phone_length != '' && data.phone_width !== undefined && data.phone_width != '' && data.phone_thickness !== undefined && data.phone_thickness != '') {
                phoneSizes = data.phone_length + 'x' + data.phone_width + 'x' + data.phone_thickness;
            }
            ...
            var tableRowElement = document.querySelectorAll(this.tableRowSelector);
        ...
        key: 'insertFormData',
        value: function insertFormData(data, rowKey) {
            this.formReset(this.formSelector);
            for (var itemKey in data) {
                var field = document.querySelector('[name="' + itemKey + '"]');
        ...
        key: 'setActiveRow',
        value: function setActiveRow(rowKey) {

            var activeClass = this.tableRowActiveClass;
            var tableRows = document.querySelectorAll(this.tableRowSelector),
        ...
        key: 'setRowsInactive',
        value: function setRowsInactive() {
            var tableRows = document.querySelectorAll(this.tableRowSelector);
        ...
        key: 'tableRowClickListener',
        value: function tableRowClickListener(data, rowKey) {
        ...
        key: 'updateItem',
        value: function updateItem(rowId) {
            var form = new _formHandler2.default(),
        ...
        key: 'deleteItem',
        value: function deleteItem(currentItemId) {
            var newRowHtml = '',
                colsNumber = 5,
                table = document.querySelector(this.tableSelector),
        ...
        key: 'activateDeleteButton',
        value: function activateDeleteButton() {
        ...
        key: 'checkIdField',
        value: function checkIdField() {
            var idField = document.querySelector('[name="' + this.formIdInputName + '"]').value;
        ...
        key: 'formReset',
        value: function formReset(formSelector) {
            var formIdInputElement = document.querySelector('[name="' + this.formIdInputName + '"]');
        ...
        value: function listenersStart() {
            ...
            var formField = document.querySelectorAll(this.formFieldSelector);

            //создание
            document.querySelector(tableButtonAddSelector).addEventListener("click", function () {
                _this2.formReset(formSelector);
                _this2.setRowsInactive();
                _this2.disableDeleteButton();
            });

            //Удаление
            document.querySelector(tableButtonDeleteSelector).addEventListener("click", function () {
                var currentItemId = _this2.checkIdField();
                if (currentItemId >= 0) {
                    _this2.deleteItem(currentItemId);
                }
            });
            ...
            document.querySelector(formSelector).addEventListener("submit", function (event) {
                ...
                var IdField = _this2.checkIdField();

                if (IdField >= 0) {
                    _this2.updateItem(IdField);
                } else {
                    _this2.addItem();
                }
            });
            ...
            for (var i = 0; i < formField.length; i++) {
                formField[i].addEventListener("change", function () {
                    var form = new _formHandler2.default();
...
var FormHandler = function () {
    ...
    _createClass(FormHandler, [{
        ...
        key: 'checkFilledForm',
        value: function checkFilledForm() {
